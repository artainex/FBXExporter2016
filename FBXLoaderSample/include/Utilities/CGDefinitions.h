...
// 4) 
#define	HAS_ATTRIBUTE(att, ptr)										(dynamic_cast<att*>(ptr)!=nullptr)



#define	CHECK_DEVICEREADY(value)									if(CCGDeviceSettingInfo::Direct3DDevice()==nullptr) { TRACE("CGC2 Error : Device is not ready\n"); return value;}
...
#define	SET_nullptr(variable)											variable=nullptr
