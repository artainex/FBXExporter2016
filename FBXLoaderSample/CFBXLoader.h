...
namespace ursine
{
	...
	public:
		...
		*/
		...
		/** @brief fbx loader update function
		*
		*  this will update the result of transformation matrix calculation
		*
		*  @return nothing
		*/
		void Update(double timedelta);

		/** @brief fbx loader update matrix palette function
		*
		*  this will update the matrix palette as calculated transformation matrix
		*
		*  @return nothing
		*/
	...
	private:
		...
		std::vector<XMMATRIX>	mtxPalArray;
		ursine::ModelInfo		m_ModelInfo;
		ursine::AnimInfo		m_AnimInfo;
	};
};	// FBX_LOADER